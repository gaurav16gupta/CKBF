...
//           while( getline ( cntfile, line1 ) ){
//             // if (a%4==0){
//             //   if (line1.size() == 0 || line1[0] != '@') {
//             //         cout<<"@ is not there or empty line"<<endl;
//             //     }
//             // }
//             if (a%4==1){
...
//         for (uint idx =0; idx<allLines[i].size()-31 +1; idx++){
//                   allKeys.push_back(allLines[i].substr(idx, 31));
//       }}
 
//       std::cout<<"total inserted from one file: "<<allKeys.size()<<std::endl;
//       return allKeys;
//   }
